...
class ModelFreeCollisionDetector():
    ...
    def __init__(self, scene_points, finger_width=0.02, depth_base=0.012):
        if finger_width <= 0 or depth_base <= 0:
            raise ValueError("finger_width and depth_base must be positive")
